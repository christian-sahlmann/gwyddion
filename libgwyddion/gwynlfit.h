...
gint gwy_math_nlfit_get_function_nparams(const GwyNLFitPresetFunction* function);

GwyNLFitter* gwy_math_nlfit_fit_preset(const GwyNLFitPresetFunction* function,
                               gint n_dat,
                               const gdouble *x,
                               const gdouble *y,
                               gint n_param,
