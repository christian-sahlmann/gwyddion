...
static const GwyRGBA nice_colors[] = {
    ...
    /* Red */
    { 0.812, 0.000, 0.000, 1.000 },  /* -> a bit darker */
    { 1.000, 0.000, 0.000, 1.000 },  /* DF */

    /* Green */
    { 0.000, 0.525, 0.000, 1.000 },  /* -> a bit darker */
    { 0.000, 0.784, 0.000, 1.000 },  /* DF */

    /* Greenish */
    { 0.220, 0.537, 0.318, 1.000 },  /* X */

    /* Blue */
    { 0.000, 0.000, 0.596, 1.000 },  /* -> a bit darker */
    { 0.000, 0.000, 1.000, 1.000 },  /* DF */

    /* Azure */
    { 0.000, 0.467, 0.467, 1.000 },
    { 0.078, 0.400, 0.545, 1.000 },
    { 0.000, 0.588, 0.588, 1.000 },  /* DF */

    /* Light greenish blue */
    { 0.000, 0.510, 1.000, 1.000 },  /* DF */
    { 0.000, 0.784, 1.000, 1.000 },  /* DF */

    /* Grey */
    /* -> something between */
    { 0.470, 0.470, 0.470, 1.000 },
    { 0.588, 0.588, 0.588, 1.000 },  /* DF */

    /* Orange */
    { 0.831, 0.588, 0.000, 1.000 },  /* -> a bit darker */
    { 1.000, 0.510, 0.000, 1.000 },  /* DF */
    { 1.000, 0.784, 0.000, 1.000 },  /* DF */

    /* Dark brown */
    /* -> keep one */
    { 0.529, 0.216, 0.000, 1.000 },
    { 0.588, 0.314, 0.000, 1.000 },  /* DF */

    /* Light brown */
    /* -> keep one */
    { 0.506, 0.533, 0.000, 1.000 },
    { 0.588, 0.588, 0.000, 1.000 },  /* DF */

    /* Dirty green-yelow */
    { 0.757, 0.580, 0.098, 1.000 },

    /* Violet */
    { 0.510, 0.000, 0.749, 1.000 },  /* -> a bit lighter */
    { 0.588, 0.000, 0.588, 1.000 },  /* DF */

    /* Purpur */
    { 1.000, 0.000, 0.510, 1.000 },  /* DF */

    /* Pink */
    { 1.000, 0.000, 1.000, 1.000 },  /* DF */
};
