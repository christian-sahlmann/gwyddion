...
#define GWY_STOCK_GRAPH_ASCII     "gwy_graph_export_ascii"
#define GWY_STOCK_GRAPH_BITMAP    "gwy_graph_export_bitmap"
#define GWY_STOCK_GRAPH_VECTOR    "gwy_graph_export_vector"
#define GWY_STOCK_GRAPH_FIT_FUNC  "gwy_graph_fit_func"
