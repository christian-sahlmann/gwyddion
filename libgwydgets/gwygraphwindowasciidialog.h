...
#define GWY_GRAPH_WINDOW_ASCII_DIALOG_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST((klass), GWY_TYPE_GRAPH_WINDOW_ASCII_DIALOG, GwyGraphWindowAsciiDialogClass))
...
#endif /* __GWY_GRAPH_WINDOW_ASCII_DIALOG_H__ */
