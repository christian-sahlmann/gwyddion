...
/**
 * SECTION:menu-windowlist
 * @title: menu-windowlist
 * @short_description: Option menu of data windows
 *
 * <warning>To be removed, reworked, and definitely changed to #GtkComboBox
 * or some other widget.</warning>
 **/
