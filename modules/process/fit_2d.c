...
static void
display_changed(GtkWidget *combo, Fit2DArgs *args)
{
    args->display_type = gwy_enum_combo_box_get_active(GTK_COMBO_BOX(combo));
    update_view(pcontrols, args);
}

static void
function_changed(GtkWidget *combo, Fit2DArgs *args)
{
