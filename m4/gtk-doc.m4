...
AC_ARG_WITH(html-dir, [  --with-html-dir=PATH    path to installed docs @<:@DATADIR/doc/AC_PACKAGE_TARNAME-AC_PACKAGE_VERSION/html@:>@])

if test "x$with_html_dir" = "x" ; then
  HTML_DIR=$datadir/doc/AC_PACKAGE_TARNAME-AC_PACKAGE_VERSION/html
else
